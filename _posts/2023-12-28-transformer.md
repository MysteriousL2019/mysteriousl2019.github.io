...
### BN Add Location
* The batch of batch normalization is a batch of data, which is divided into small batches for stochastic gradient descent. Moreover, when each batch of data is subjected to forward propagation, normalization is performed on each layer. 
### BN Result
